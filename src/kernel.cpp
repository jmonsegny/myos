...
extern "C" void kernelMain( void* multiboot_structure, uint32_t magicnumber )
{
	...
	uint32_t* memupper = (uint32_t*)((size_t)multiboot_structure + 8); //Third 32bit field
	size_t size = (*memupper)*1024 - heap - 10*1024;
	MemoryManager memoryManager( heap, size);		 
	...
	allocated = memoryManager.malloc(1024);
